...
function addSingleAdventureToDOM(
  id,
  category,
  image,
  name,
  ...
  cardTextDiv.setAttribute(
    "class",
    "row justify-content-between align-content-"
  );
...
function filterFunction(list, filters) {
  ...
  //both filtered
    ...
    let high = filters.duration.substring(
      filters.duration.indexOf("-") + 1,
